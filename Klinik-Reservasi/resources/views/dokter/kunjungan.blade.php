...
<body>
    ...
    <div class="form-container">
        ...
        <form action="{{ route('dokter.kunjungan.store') }}" method="POST">
            ...
            <label>NIK</label>
            <input type="text" name="nik" placeholder="Masukkan NIK pasien">

            <label>Umur</label>
            <input type="number" name="umur" placeholder="Umur pasien">
            ...
            <textarea name="keluhan" placeholder="Isi keluhan pasien..."></textarea>

            <h3 style="color:#007d8a;">Hasil Pemeriksaan</h3>

            <label>Diagnosa</label>
            <textarea name="diagnosa" placeholder="Isi diagnosa"></textarea>

            <label>Obat / Resep</label>
            <textarea name="resep" placeholder="Isi obat / terapi"></textarea>

            <label>Catatan Tambahan</label>
            <textarea name="catatan" placeholder="Tambah catatan jika ada"></textarea>
